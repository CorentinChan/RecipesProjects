...
export default function Commentaires({ recipeID, udpateForm, userRole }) {
  ...
  //AXIOS REQUEST TO GET COMMENTAIRES DATA
  ...
  //when recipeID change get commentaire for new recipe displayed
  useEffect(() => {
  ...
  //delete commentaire with admin role with a axios request
      ...
      {comments &&
        comments.map((comment, index) => (
          <div
            ...
            className={
              index % 2
                ? "list-group p-lg-3 com-container2"
                : "list-group p-lg-3"
            }
          >
            <div
              className={
                index % 2
                  ? "list-group-item  bg-danger-subtle"
                  : "list-group-item "
              }
              aria-current="true"
            >
              <div className=" w-100 justify-content-between">
                <div className="d-flex ">
                  <img
                    className="imageComm fs-1 mx-lg-0 me-2 me-lg-3 py-1   rounded-circle"
                    src={
                      comment.image
                        ? comment.image
                  ...
                  <div className="d-flex flex-column mt-2 mt-lg-3">
                    ...
                    {userRole === "admin" && (
                      <p>
                        id : {comment.userID} , {comment.mail}{" "}
                      </p>
                    )}
              ...
              {/* Admin role display to delete comment */}
              {userRole === "admin" && (
                <form
                ...
                >
                  <button
                    type="submit"
                    class="btn bg-danger text-center rounded-pill border-black border-1"
                  >
                    Delete comment
                  </button>
