        ...
        <div className="container justify-content-center">
          ...
          <div className="d-flex text-center descriptionLogos border">
            <div className="logo1 p-2 mx-2 m-lg-3 px-lg-5 text-center border-end">
              ...
              <input className="form-control form-control-sm" type="text" placeholder="enter active time" maxLength={20}
            ...
            <div className="logo2 p-2 mx-2 m-lg-3 px-lg-5 text-center border-end">
              ...
              <input className="form-control form-control-sm" type="text" placeholder="enter total time"  maxLength={20}
            ...
            <div className="logo3 p-2 mx-2 m-lg-3 px-lg-5 text-center">
              ...
              <input className="form-control form-control-sm" type="text" placeholder="enter yield" maxLength={20}
