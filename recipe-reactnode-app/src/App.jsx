          ...
          <Routes>
            <Route element={<Dashboard />}>
              ...
              <Route
                path="/recipe"
                element={
                  <Recipe user={user} userRole={userRole} key={Date.now()} />
                }
              />
              ...
              <Route
                path="/account"
                element={<Account user={user} userRole={userRole} />}
              />
              <Route
                path="/modifyRecipe"
                element={<ModifyRecipe user={user} userRole={userRole} />}
              />
              ...
              {!user ? (
                ...
                <Route
                  path="/signin"
                  element={<p class="text-center">Not available</p>}
                />
              )}
            </Route>
          </Routes>
