...
<button type="button" class="btn bg-light border" data-bs-toggle="modal" data-bs-target="#exampleModal">
  <a>Forget your password?</a>
    ...
    : <p class="text-warning">A new password have been sent, check your mail!</p> 
 }

<div
  className="modal fade mt-5"
  id="exampleModal" ref={modalRef}
    ...
    <div className="modal-content">
      <div className="modal-header">
        ...
        <div className="modal-body justify-content-center">
          ...
          <input
            type="email" name="mail"  placeholder="type your e-mail"  required
