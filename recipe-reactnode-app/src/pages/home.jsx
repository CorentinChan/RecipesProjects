            ...
            <div className="signup-text">
              ...
              {!user ? (
                <>
                  ...
                  <h3 className="mb-3 ">
                    {" "}
                    sign up to access to a lot of recipes, add your own recipes,
                    and many more
                  </h3>
                  <a className=" d-flex text-decoration-none text-white">
                    <h3 onClick={() => setShowSignup(true)}>Sign up today </h3>
                    <i className="fa-solid fa-arrow-right m-2 p-2 fa-lg"></i>{" "}
                  </a>{" "}
                </>
              ) : (
                <h3 className="mb-3 ">
                  {" "}
                  Welcome! Now, add your own recipes on account page, comment
                  your favorite recipes and many more
                </h3>
              )}
            </div>
          </div>
